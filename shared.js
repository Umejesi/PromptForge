...
// ════════════════════════════════════════
// USER MENU — a real dropdown (Dashboard / Premium / Sign out)
// instead of an avatar that either does nothing or signs you out
// the instant you tap it. Any page with a [data-user-initials]
// avatar wrapped in .user-menu-wrap + #userMenu gets this for free.
// ════════════════════════════════════════
...
document.addEventListener('click', (e)=>{
  ...
  if(menu && menu.classList.contains('open') && !menu.contains(e.target) && !e.target.closest('.user-avatar')){
